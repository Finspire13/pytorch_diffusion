...
def denoising_step_combined(x, t, *,
    ...
    weight = weights[:,int(t.item())].unsqueeze(1).unsqueeze(1).unsqueeze(1).unsqueeze(1) # only for n=1    
...
def denoising_step_combined_with_weight_maps(x, t, *,
                   models,
                   weight_maps,
                   logvar,
                   sqrt_recip_alphas_cumprod,
    ...
    weight = weight_maps.unsqueeze(1).unsqueeze(1) # only for n=1    #(3, 1, 1, 256, 256)
